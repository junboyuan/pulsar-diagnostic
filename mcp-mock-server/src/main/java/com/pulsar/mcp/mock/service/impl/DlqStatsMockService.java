...
/**
 * Mock service for DLQ (Dead Letter Queue) statistics.
 */
@Service
public class DlqStatsMockService implements MockDataService {

    private final MockDataGenerator dataGenerator;
    private final ObjectMapper objectMapper;

    public DlqStatsMockService(MockDataGenerator dataGenerator, ObjectMapper objectMapper) {
    ...
    public String getToolDescription() {
        return "Get Dead Letter Queue statistics for a topic";
    }
    ...
    public String execute(Map<String, Object> arguments) {
        try {
            ...
            Map<String, Object> result = dataGenerator.generateDlqStats(topic);
